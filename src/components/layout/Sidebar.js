...
export default function Sidebar() {
  return (
    <div className="left-side">
      ...
      <Menu></Menu>
      <ContactInfo className="" title="Contact Info">
        <ul>
          <li>
            <span className="icon">
          ...
          <li>
            ...
            <span className="text">
              <a target="_blank" href="https://yudhistira.id">
                yudhistira.id
              </a>
            </span>
          </li>
          <li>
            ...
            <span className="text">
              <a target="_blank" href="https://github.com/ariesdimasy">
                ariesdimasy
              </a>
            </span>{" "}
            ,
            <span className="text">
              <a target="_blank" href="https://github.com/kunglaw">
                kunglaw
              </a>
            </span>
          </li>
      ...
      <ContactInfo className="education" title="Education">
        <ul>
          <li>
            <h5> 2008 - 2012 </h5>
      ...
      <ContactInfo className="language" title="languages">
        <ul>
          <li>
      ...
      <ContactInfo classNameName="download">
        <a
          style={{ color: "white", textDdecoration: "none" }}
          target="_blank"
          href="https://drive.google.com/file/d/1h_ospp-frNJ35BX6hmvBI6jVvDLVgDuV/view?usp=sharing"
        >
          <h3 className="title">Download Full CV</h3>
        </a>
      </ContactInfo>
    </div>
  );
